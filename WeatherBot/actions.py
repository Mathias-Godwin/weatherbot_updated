    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if loc not None:
            try:
                ...
                response = """It is currently "{}" in "{}" at the moment. The temperature is "{}" degrees, the humidity is "{}%" and the wind speed is "{}" mph. \nNETWORK ERROR! check your internet connection.""".format(condition, city, temperature_c, humidity, wind_mph)
                dispatcher.utter_message(response)
